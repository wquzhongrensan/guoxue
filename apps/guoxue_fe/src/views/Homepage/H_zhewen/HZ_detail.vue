	...
	<div style="width: 1000px;margin: 0 auto;">
		<div class="h_g_nav">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item :to="{ path: '/H_zhewen' }">哲学文化</el-breadcrumb-item>
				<el-breadcrumb-item :to="{ path: '/H_zhewen/HZ_detail' }">详情</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="hs_d_bottom">
			
			<div class="hs_d_bottom_bottom" style="background: white;">
			...
			<div class="hs_d_bottom_bottom_bottom_line"></div>
		</div>
	</div>
